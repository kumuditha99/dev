...
prometheus.exporter.unix "metrics" {
  ...
  filesystem {
    fs_types_exclude     = "^(autofs|binfmt_misc|cgroup2?|configfs|debugfs|devpts|devtmpfs|fusectl|hugetlbfs|mqueue|proc|pstore|rpc_pipefs|securityfs|squashfs|sysfs|tracefs)$" 
